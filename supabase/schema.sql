  ...
  -- ---------------------------------------------------------------------------
  -- place_images: 장소별 공유 사진 (두 사람의 사진을 한 곳에서 관리)
  -- ---------------------------------------------------------------------------
  ...
  -- 본인 사진 INSERT
  create policy "place_images_insert" on public.place_images
  ...
  -- 본인 사진 DELETE
  create policy "place_images_delete" on public.place_images
