...
if (!fs.existsSync(envPath)) {
  ...
  console.error('Create it from .env.example and fill provider credentials before starting the app.');
  process.exit(1);
}
...
if (missing.length > 0) {
  ...
  console.error('Fill these values in your local env file before starting the app.');
  process.exit(1);
}
